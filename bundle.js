...
function favicon(density, crystalSize, gapHor, gapVer) {
	var STROKE_MAX = 2;

	var clippingX = (gapHor - STROKE_MAX) * density;
	var clippingY = (gapVer - STROKE_MAX) * density;
	var clippingSize = (crystalSize + 2 * STROKE_MAX) * density;

	var firstCrystal = document.querySelector("canvas").getContext("2d").getImageData(clippingX, clippingY, clippingSize, clippingSize);
	var faviconCnv = document.createElement("canvas");
	var faviconCtx = faviconCnv.getContext("2d");
	...
	var faviconLnk = document.querySelector("link");
